package org.rciot.smartapp.ui.environment
...
import org.rciot.smartapp.databinding.FragmentEnvironmentBinding
...
class EnvironmentFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = FragmentEnvironmentBinding.inflate(layoutInflater, container, false)
                ...
                try {
                    ...
                    handler.post {
                        ...
                        with(binding) {
                            ...
                            if (data.TDS1 > 200 && data.TDS1 <= 1300)
                                tvCurrentStatus.apply {
                                    text = "Safe"
                                    setTextColor(resources.getColor(R.color.tds_safe))
                                }
                            if (data.TDS1 > 1300 && data.TDS1 <= 1700)
                                tvCurrentStatus.apply {
                                    text = "Cautious"
